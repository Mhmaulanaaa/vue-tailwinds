<template>
  <div class="grid grid-cols-2 gap-6 sm:grid-cols-2 md:gap-4">
    <div
      class="rounded-2xl border border-gray-200 bg-emerald-500 p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6"
    >
      <div
      ...
      <div class="flex items-end justify-between mt-5">
        <div>
          <span class="text-sm text-neutral-100 dark:text-neutral-100"
            >Total Kunjungan</span
          >
          <h4 class="mt-2 font-bold text-neutral-100 text-title-sm dark:text-white/90">
            200
          </h4>
        </div>
    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        <div>
          <span class="text-sm text-neutral-100 dark:text-neutral-100">Total Pasien</span>
          <h4 class="mt-2 font-bold text-neutral-100 text-title-sm dark:text-white/90">
            250
          </h4>
        </div>
